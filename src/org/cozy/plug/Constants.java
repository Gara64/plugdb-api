...
{
	public final static int INSERT_RULE = 0;
	public final static int INSERT_USERID = 1;
	public final static int INSERT_DOCID = 2;
	
	public final static int SELECT_RULES_BY_USERID = 10;
	public final static int SELECT_STAR_BY_USERRULE = 11;
	public final static int SELECT_STAR_RULES = 12;
	public final static int SELECT_STAR_USERS = 13;
	public final static int SELECT_STAR_DOCS = 14;
	public final static int SELECT_DOCID_BY_USERID = 15;
