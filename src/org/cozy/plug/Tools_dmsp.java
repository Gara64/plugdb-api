...
public class Tools_dmsp {
    ...
    // INSERT INTO QEP (Synch)
 	public static void Test_QEP_INSERT(
 			int IdGlobal, String QEPStr, Blob SQLStr, Blob ExplainStr, 
 			java.sql.PreparedStatement Pstmt)
 			throws Exception {
 		Pstmt.setInt(1, IdGlobal); Pstmt.setString(2, QEPStr);
 		Pstmt.setBlob(3, SQLStr); Pstmt.setBlob(4, ExplainStr);
 		Pstmt.executeUpdate();
 	}
	...
	//--------------------- DEMO EDF --------------------- //
		public static int CATEGORIE_INSERT(
				int IdGlobal, String nom, java.sql.PreparedStatement Pstmt) throws Exception
		{
			Pstmt.setInt(1, IdGlobal);
		...
		public static int CATEGORIEEQ_AC_INSERT(
				int IdGlobal, String nom, String desc, java.sql.PreparedStatement Pstmt) throws Exception
		{
			Pstmt.setInt(1, IdGlobal);
			Pstmt.setString(2, nom);
		...
		public static int EQUIPEMENT_INSERT(
				int IdGlobal, int idCategorie, String nom, int puissance, java.sql.PreparedStatement Pstmt) throws Exception
		{
			Pstmt.setInt(1, IdGlobal);
			Pstmt.setInt(2, idCategorie);
			Pstmt.setString(3, nom);
			Pstmt.setInt(4, puissance);
			int res = Pstmt.executeUpdate();
			return res;
		}
		
		public static int ACTION_INSERT(
				int IdGlobal, int idEquipement, String nom, String type, java.sql.PreparedStatement Pstmt) throws Exception
		{
			Pstmt.setInt(1, IdGlobal);
			Pstmt.setInt(2, idEquipement);
			Pstmt.setString(3, nom);
			Pstmt.setString(4, type);
			int res = Pstmt.executeUpdate();
			return res;
		}
		public static int EVENEMENT_INSERT(
				int IdGlobal, int idAction, Date DateVal, int TimeVal, java.sql.PreparedStatement Pstmt) throws Exception
		{
			Pstmt.setInt(1, IdGlobal);
			Pstmt.setInt(2, idAction);
			Pstmt.setDate(3,  DateVal);
			Pstmt.setInt(4, TimeVal);
			int res = Pstmt.executeUpdate();
			return res;
		}
		
		public static int ACTION_INSERT_NEW(
				int IdGlobal, int idCategorie, String nom, String type, java.sql.PreparedStatement Pstmt) throws Exception
		{
			Pstmt.setInt(1, IdGlobal);
			Pstmt.setInt(2, idCategorie);
			Pstmt.setString(3, nom);
		...
		public static int EVENEMENT_INSERT_NEW(
				int IdGlobal, int idEquipement, int idAction, Date DateVal, int TimeVal, java.sql.PreparedStatement Pstmt) throws Exception
		{
			Pstmt.setInt(1, IdGlobal);
			Pstmt.setInt(2, idEquipement);
			Pstmt.setInt(3, idAction);
			Pstmt.setDate(4,  DateVal);
			Pstmt.setInt(5, TimeVal);
			int res = Pstmt.executeUpdate();
			return res;
		}
		
		public static java.sql.ResultSet Test_SELECT_BY_DATE(
	    		Date DateVal, java.sql.PreparedStatement Pstmt) throws SQLException
	    {
		...
		public static java.sql.ResultSet Test_SELECT_BY_DATE_AND_DATE(
				Date DateVal1, Date DateVal2, java.sql.PreparedStatement Pstmt)
				throws Exception {
			Pstmt.setDate(1, DateVal1);
			Pstmt.setDate(2, DateVal2);
			java.sql.ResultSet rs = Pstmt.executeQuery();
			return rs;
		}
		public static java.sql.ResultSet Test_SELECT_BY_INT_AND_STRING_AND_DATE_AND_DATE(
				int IntVal, String StringVal, Date DateVal1, Date DateVal2, java.sql.PreparedStatement Pstmt)
				throws Exception {
			Pstmt.setInt(1, IntVal);
			Pstmt.setString(2, StringVal);
			Pstmt.setDate(3, DateVal1);
			Pstmt.setDate(4, DateVal2);
			java.sql.ResultSet rs = Pstmt.executeQuery();
			return rs;
		}
